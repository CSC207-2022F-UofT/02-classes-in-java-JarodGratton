...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param s1 the string that makes up the first part of this Silly instance's name.
     * @param s2 the string that makes up the second part of this Silly instance's name.
     */
